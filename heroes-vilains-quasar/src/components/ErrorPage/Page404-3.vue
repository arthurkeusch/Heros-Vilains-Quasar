<template>
  ...
  <div class="house house--first-floor">
    ...
    <div class="house__bottom">
      ...
      <label class="house-toggle" for="toggle"><span class="house__window"><span class="cat"><span
        class="cat__face"></span><span class="cat__body"></span></span><span class="present"><span
        class="present__ribbon"></span></span></span></label>
  ...
  <div class="house house--second-floor">
    ...
    <div class="house__bottom">
      ...
      <label class="house-toggle" for="toggle2"><span class="house__window"><span class="tree"><span
        class="tree__body"></span><span class="tree__decorations"><span class="tree__decoration"></span><span
        class="tree__decoration"></span><span class="tree__decoration"></span><span
        class="tree__decoration"></span><span
        class="tree__decoration"></span><span class="tree__decoration"></span></span></span></span></label>
      <div class="house__door"></div>
    </div>
